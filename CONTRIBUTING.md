# How to contribute to  cozy-twakecalendar?
...
- What is the version of the  cozy-twakecalendar app?
...
```
$ git clone github.com/cozy/ cozy-twakecalendar.git
$ cd  cozy-twakecalendar
$ git remote add fork git://github.com/yourusername/ cozy-twakecalendar.git
```
...
Go to https://github.com/yourusername/ cozy-twakecalendar and select your branch. Click the 'Pull Request' button and fill out the form.
...
The  cozy-twakecalendar is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/cozy/ cozy-twakecalendar/issues/new
...
[localization]: https://github.com/cozy/ cozy-twakecalendar/blob/master/README.md#localization
